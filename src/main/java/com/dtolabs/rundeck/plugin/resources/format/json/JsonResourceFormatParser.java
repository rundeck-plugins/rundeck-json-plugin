...
public class JsonResourceFormatParser implements ResourceFormatParser {
    ...
    public INodeSet parseDocument(File file) throws ResourceFormatParserException {
        try {
            ...
            try {
                final INodeSet iNodeSet = parseDocument(fileInputStream);
                System.err.println("node set: "+iNodeSet);
                return iNodeSet;
            } finally {
    ...
    public INodeSet parseDocument(InputStream inputStream) throws ResourceFormatParserException {
        ...
        NodeSetImpl nodeset = nodeSetFromNodes(nodes);
        return nodeset;
    }

    static  NodeSetImpl nodeSetFromNodes(Nodes nodes) {
